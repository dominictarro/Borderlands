...
landing_bucket = create_child_bucket("landing", "-landing", parent=oryx_bucket, save=True)
assets_bucket = create_child_bucket("assets", "-assets", parent=oryx_bucket, save=True)
persistence_bucket = create_child_bucket("persistence", "-persistence", parent=oryx_bucket, save=True)
